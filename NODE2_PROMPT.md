...
| D2-15 | `re10k_rayropew_s137` | `config/rayrope_ttt_world.yaml` (**RayRoPE world-frame**: 카메라 중심 + 3-ray depth 대역(σ 구간평균) 좌표를 장면 공용 좌표계로, 단일 메모리·표준 TTT 비용; q/k + v/o, σ₀=3, init 수정판) | RE10K | [PENDING — 스모크 후] |
| D2-16 | `gobj_rayropew_s137` | 같은 config (`DATA=gobj`) | orbit | [PENDING] |
| D2-17 | `dl3dvu_rayropew_s137` | 같은 config (`IMG="256 448"`) | DL3DV-u | [PENDING] |
