...
| DP-26 | `re10k_dpmem_h_s137` | `config/dp_mem_h.yaml` | RE10K | [RUNNING node1 gpu1 10:31] |
...
| DP-27 | `gobj_dpmem_in_s137` | `config/dp_mem_in.yaml` (`DATA=gobj`) | orbit | [RUNNING node1 gpu0 10:47] |
