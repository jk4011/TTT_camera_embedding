...
| DP-32 | `re10k_dpmlp_pdir0_s137` | `config/dp_mlp_pdir0_both.yaml` | RE10K | [RUNNING node1 gpu1 01:40 — pdir0가 RE10K에서 방향 gain을 스스로 키워 pdir(22.903)에 도달하는가 = 단일 레시피 판정] |
| DP-33 | `dl3dvu_dpmlp_pdir0_s137` | 같은 config (`IMG="256 448"`) | DL3DV-u | [PENDING — 다음 빈 GPU] |
...
| DP-15 | `gobj_dpmlp_in_s137` | `config/dp_mlp_in.yaml` (`DATA=gobj`) | orbit | [RUNNING node1 gpu2 00:19] |
| DP-16 | `gobj_dpmlp_h_s137` | `config/dp_mlp_h.yaml` (`DATA=gobj`) | orbit | [RUNNING node1 gpu0 01:01] |
