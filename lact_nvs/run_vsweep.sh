...
case "$DS" in
  re10k)    declare -A EXP=( [base]=base_s137 [input]=pra_hi_s137 [hidden]=h_pra_hi_s137 [both]=pra_h_hi_s137 [dpmlp]=re10k_dpmlp_s137 [dpgate]=re10k_dpmlp_pdirgh_s137 ); DP=/tmp/re10k/test_index.json; NSC=256; EXTRA=(--min_frames 52) ;;
  ...
  dl3dvu)   declare -A EXP=( [base]=dl3dvu_base_s137 [input]=dl3dvu_input_s137 [hidden]=dl3dvu_hidden_s137 [both]=dl3dvu_both_s137 [dpmlp]=dl3dvu_dpmlp_s137 [dpgate]=dl3dvu_dpmlp_pdirgh_s137 ); DP=/tmp/dl3dv/test_index.json; NSC=140; EXTRA=(--min_frames 52 --image_size 256 448); WIDE=1 ;;   # TRUE uncropped DL3DV (256x448)
  ...
  gobj137)  declare -A EXP=( [base]=gobj_base_s137 [dpmlp]=gobj_dpmlp_s137 [dpgate]=gobj_dpmlp_pdirgh_s137 ); DP=/tmp/gobj/test_index.json; NSC=500; EXTRA=(--min_frames 36) ;;   # orbit, seed-137 DP arms (views <= 32)
