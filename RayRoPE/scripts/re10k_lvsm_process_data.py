...
# python scripts/lvsm_process_data.py --base_path /ocean/projects/cis240058p/ywu15/re10k_raw --output_dir /ocean/projects/cis240058p/ywu15/re10k --mode 'test'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='/grogu/user/yuwu3/re10k/')
    parser.add_argument("--base_path", type=str, default='/grogu/user/yuwu3/re10k_raw/')
