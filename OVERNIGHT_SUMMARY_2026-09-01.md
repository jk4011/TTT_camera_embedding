...
- 시드 재현(규약: 셀 시드평균 vs base 시드평균, ±시드 std): base 21.984±0.099; **`foot_all_iso` 22.809±0.029 (Δ +0.825)**; rot_hshell 22.597±0.087 (Δ +0.613; s211 +0.461로 폭 넓음); `foot_all_iso`(iso만) 3-seed +0.851 / +0.890 / +0.734(각 시드 base와 짝지음,
